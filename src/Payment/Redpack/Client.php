...
class Client extends BaseClient
{
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function sendWorkRedpacket(array $params, $workwxSecret = '')
    {
        $base = [
            'wxappid' => $this->app['config']->app_id,
        ];

        return $this->safeWorkRequest('mmpaymkttransfers/sendworkwxredpack', array_merge($base, $params), $workwxSecret);
    }
