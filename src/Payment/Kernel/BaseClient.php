...
class BaseClient
{
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    protected function requestForWork(string $endpoint, array $params = [], $method = 'post', array $options = [], $returnResponse = false, $workwxSecret = '')
    {
        $base = [
            'mch_id' => $this->app['config']['mch_id'],
            'nonce_str' => uniqid(),
        ...
        $params['workwx_sign'] = Support\generate_workwx_sign([
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    protected function safeWorkRequest($endpoint, array $params, $workwxSecret = '', $method = 'post', array $options = [])
    {
        $options = array_merge([
            'cert' => $this->app['config']->get('cert_path'),
            'ssl_key' => $this->app['config']->get('key_path'),
        ...
        return $this->requestForWork($endpoint, $params, $method, $options, false, $workwxSecret);
    }
